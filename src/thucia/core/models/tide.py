...
class TiDESamples(DartsBase):
    ...
    def pre_fit(self, target_gids=None, **kwargs):
        logging.info(
            "Fitting TiDE model on historical data "
...
def tide(
    ...
    """Temporal Fusion Transformer (TiDE) forecasting pipeline.

    Returns a Thucia DataFrame if db_file is specified, otherwise a pandas DataFrame.
    """

    logging.info("Starting TiDE forecasting pipeline...")
    ...
    logging.info("Completed TiDE forecasting pipeline.")
