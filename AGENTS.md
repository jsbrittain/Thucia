...
- Model input DataFrames need columns `Date, GID_1, GID_2, future, Cases, Log_Cases` plus covariates. Covariates must be NaN-free — run `sanitise_covariates()` first and assert no NaNs.
